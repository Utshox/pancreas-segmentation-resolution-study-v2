...
def plot_comparison(log_256, log_128, output_dir):
    """
    Reads two Keras log.csv files and plots a comparison.
    """
    ...
    if 'val_io_u' in df_256.columns and 'val_io_u' in df_128.columns:
        ...
        plt.title('Validation IoU: Resolution Ablation', fontweight='bold')
        plt.xlabel('Epoch')
...
def main():
    ...
    plot_comparison(args.log_256, args.log_128, args.output_dir)
