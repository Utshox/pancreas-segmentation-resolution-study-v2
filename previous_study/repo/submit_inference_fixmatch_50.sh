...
#SBATCH --mem=32G
#SBATCH --gres=gpu:1
#SBATCH --job-name=ssl_inf_50
#SBATCH --output=%j_ssl_inf_50.log

echo "Starting SSL (FixMatch 50%) Inference..."
hostname
date
nvidia-smi
...
# Point to 50% Results
MODEL_PATH="$HOME/ish/results_fixmatch_50/model_fixmatch_best.h5"
OUTPUT_DIR="results_inference_fixmatch_50"
...
# Call the FIXED python script (v2 logic)
