...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{ssl_framework_overview.png}
\caption{Overview of the three SSL frameworks. (a)~Mean Teacher: MSE consistency between student and EMA teacher. (b)~UA-MT: MC Dropout uncertainty ($T=8$) weights consistency loss. (c)~CPS: two networks mutually generate pseudo-labels.}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{hu_windowing_comparison.png}
\caption{HU windowing comparison. (a)~Raw CT. (b)~Standard window $[-100, 240]$. (c)~Our optimized window $[-125, 275]$ (+4.94\% Dice gain).}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{fourier_radial_spectrum.png}
\caption{Frequency-domain analysis. (a)~Radial power spectrum: downsampling eliminates high frequencies overlapping with pancreas boundary content (purple). (b)~Frequency loss map. (c)~Spatial loss (red) concentrated at organ boundaries (green).}
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=\columnwidth]{ssl_all_iou_comparison.png}
\caption{Validation IoU curves across the 10\%, 25\%, and 50\% labeled data regimes. UA-MT demonstrates superior stability; CPS collapses at low data regimes.}
