...
\begin{figure*}[t]
\centering
\includegraphics[width=\textwidth]{images/inference_comparison_005.png}
\caption{Qualitative comparison on the challenging Pancreas\_005 case. From left to right: Raw CT Slice, Ground Truth Mask, Fully Supervised SOTA prediction, and the UA-MT (50\% Labels) prediction. The UA-MT model successfully recovers complex boundary topologies that the fully supervised model fails to capture.}
